...
<body>
  ...
  <header class="site-header" id="site-header">
    <div class="shell header-inner">
      <a class="brand" href="${prefix}index.html" aria-label="Dolphin Systems home">
        <img class="brand-mark" src="${prefix}assets/brand-mark.svg" alt="" width="38" height="38">
  ...
  <footer class="site-footer">
    <div class="shell footer-main">
      <div><a class="brand" href="${prefix}index.html"><img class="brand-mark" src="${prefix}assets/brand-mark.svg" alt="" width="38" height="38"><span>Dolphin<span class="brand-light">Systems</span></span></a><p>Making complex systems easier to run.</p></div>
