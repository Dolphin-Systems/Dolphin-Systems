...
<body>
  ...
  <footer class="site-footer">
    <div class="shell footer-main">
      ...
      <div class="footer-contact"><span>Have a system in mind?</span><a href="mailto:${email}">${email} <span aria-hidden="true">↗</span></a><button class="chat-link" type="button" data-open-lila><img class="chat-icon" src="${prefix}assets/lila-avatar.png" alt="" aria-hidden="true"> Chat with Lila</button></div>
    </div>
