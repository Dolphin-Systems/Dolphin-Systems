...
const assetVersion = '20260923-lila-close-right';
...
<body>
  ...
  <footer class="site-footer">
    <div class="shell footer-main">
      ...
      <div class="footer-contact"><span>Have a system in mind?</span><a href="mailto:${email}">${email} <span aria-hidden="true">↗</span></a><button class="chat-link" type="button" data-open-lila><span class="chat-icon" aria-hidden="true">L</span> Chat with Lila</button></div>
    </div>
