...
<body>
  ...
  <footer class="site-footer">
    <div class="shell footer-main">
      ...
      <div class="footer-contact"><span>Have a system in mind?</span><a href="mailto:${email}">${email} <span aria-hidden="true">↗︎</span></a><button class="chat-link" type="button" data-open-lila><img class="chat-icon" src="${prefix}assets/lila-avatar.png" alt="" aria-hidden="true"> Chat with Lila</button></div>
    </div>
...
const pages = [
  ...
  },
  {
    ...
    <section class="section shell section-tight"><div class="section-heading"><div><span class="kicker">Sample cards</span><h2>Sample services.</h2></div><p class="section-aside">Example engagements, to show what working together could look like.</p></div><div class="product-grid"><article class="product-card"><span class="product-icon" aria-hidden="true">✎</span><span class="kicker">SAMPLE 01</span><h3>Workflow mapping</h3><p>A sample engagement where we document how work actually moves through your team, then mark exactly what to automate.</p></article><article class="product-card"><span class="product-icon" aria-hidden="true">🔗</span><span class="kicker">SAMPLE 02</span><h3>Systems integration</h3><p>A sample engagement where we connect the tools you already use, so information arrives where it is needed.</p></article><article class="product-card"><span class="product-icon" aria-hidden="true">⚙</span><span class="kicker">SAMPLE 03</span><h3>Automation build</h3><p>A sample engagement where we design, build, and test the workflow with your team, then hand over the keys.</p></article></div></section><section class="soft-section"><div class="shell split-section"><div><span class="kicker">The working method</span><h2>Understand first. Build with purpose.</h2></div><div class="steps"><div><b>01</b><p>Map the current workflow and the outcome you need.</p></div><div><b>02</b><p>Choose the smallest change that solves the real problem.</p></div><div><b>03</b><p>Build, test, and make the system understandable to its owners.</p></div><div><b>04</b><p>Measure what changed and keep improving it.</p></div></div></div></section>${cta}`,
  },
  {
